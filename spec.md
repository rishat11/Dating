...
| Термин | Определение |
|--------|-------------|
| **Индекс Судьбы** | Динамический показатель совместимости пары (0–100%), рассчитываемый по переписке; определяет уровень и разблокируемые функции. |
...
- **Цель**: знакомства через Telegram с игровой механикой совместимости («Индекс Судьбы»), удержание за счёт прогресса в паре и разблокировки уровней.
...
- При необходимости — жалобы, блокировка, завершение чата (индекс обнуляется при новом матче, как в фиче).

---

## 4. Индекс Судьбы 2.0 (из feature.md)
...
| 91–100% | Судьба             | Секрет: PDF «История нашей любви» (таймлайн, лучшие фразы, зодиак) или сертификат на свидание             |
...
- **Краевые случаи**:
  ...
  - Отмена матча (если предусмотрена): обнуление индекса для этой пары, скрытие чата.
...
- **Индекс Судьбы**: пара_id, текущий_процент, история изменений (по желанию — помесячно/по уровням), последние события (причина роста/падения), флаги разблокировок (плейлист, челленджи, облако, голосование, PDF).
...
- Запрет на передачу контактов до согласованного уровня (например, до «Судьба» или отдельная опция).
...
2. **Индекс Судьбы MVP**: лексический + поведенческий уровень, тайм-трекер, простой прогресс-бар и уведомления о росте/падении, уровни 0–15%, 16–30%, 31–50% (плейлист + челленджи).
...
Спецификация готова к использованию как ТЗ для разработки телеграм-бота для знакомств с фичей «Индекс Судьбы» из feature.md.
